<?php
 ...
 $CID=$rw['id']; // CLIENT ID
 $Order1C=new OrderC();
 $liste=$Order1C->displayCosOrders($CID);
 $count=0;
 ?>
<!DOCTYPE html>
<html lang="en">
                             ...
                             echo '
                                    <tr>
                                        ...
                                        <td class="cart_product_desc">
                                            <h5>White Modern Chair</h5><h6>x'.$row['Qty'].'</h6>
                                        </td>
                                        <td class="price">
                                            <span>'.$row['Prix'].' DT</span>
                                        </td>
                                        <td class="cart_product_desc">
                                            <h5>'.$row['date_expiration'].'</h5><h6>'.$row['Cord'].'</h6><h6>'.$row['etat_commande'].'</h6>
                                        </td>
                                        <td>
                                        <form method="POST" action="deleteCosOrder.php">
                                    <li class="col-md-3">
                    <input type="submit" name="update" class="btn btn-dark" value="SUPPRIMER" class="btn" >
                    </li>
